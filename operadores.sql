...
select 
    email, 
    income,
    cast((income/1200) as numeric(15,2)) as "Salario Minimo"
...
select 
    ...
    income,
    cast((income/1200) as numeric(15,2)) as "Salario Minimo",
    (cast((income/1200) as numeric(15,2))>=5) as "Acima de 4 Salarios"
from sales.customers
...
select 
    ...
    income,
    cast((income/1200) as numeric(15,2)) as "Salario Minimo",
    (cast((income/1200) as numeric(15,2))>=4) as "Acima de 4 Salarios"
from sales.customers
where cast((income/1200) as numeric(15,2)) between 4 and 5
